...
void MG(double ***Pex, double ***E, int niveis, double ****e, double ****R, double ****rhs, double ***P, double ***B, double ****Ap, double ****Ae, double ****Aw, double ****An, double ****As, double ****Au, double ****Ad, int *itr_u, int *itr_d, int *nx, int *ny, int *nz, double D, double L, double S, double *h, double *w, double eps, int fun, char fron)
{
      ...
      {             
		   ...
		   sor(P, B, Ap[t], Ae[t], Aw[t], An[t], As[t], Au[t], Ad[t], nx[t], ny[t], nz[t], D, L, S, h[t], w[t], itr_d[t], 1, fun, fron);
           ...
           while(t > 0)
           {
                ...
                t--;
                sor(e[t], rhs[t], Ap[t], Ae[t], Aw[t], An[t], As[t], Au[t], Ad[t], nx[t], ny[t], nz[t], D, L, S, h[t], w[t], itr_d[t], 0, fun, fron);	
           ...
           while(t < (niveis-1))
           {
			    ...
			    if(t != (niveis-1))
				     sor(e[t], rhs[t], Ap[t], Ae[t], Aw[t], An[t], As[t], Au[t], Ad[t], nx[t], ny[t], nz[t], D, L, S, h[t], w[t], itr_u[t], 0, fun, fron);
...
void sor(double ***P, double ***B, double ***Ap, double ***Ae, double ***Aw, double ***An, double ***As, double ***Au, double ***Ad, int nx, int ny, int nz, double D, double L, double S, double h, double w, int itr, int sit, int fun, char fron)
{
     int it, i, j, k;
     
     fronteira(P, h, nx, ny, nz, D, L, S, fun, fron, sit);
               ...
               for(j=1; j<(ny-1); j++)
			        for(k=1; k<(nz-1); k++)
                         P[i][j][k] = (w/Ap[i][j][k])*(B[i][j][k]-(Ae[i][j][k]*P[i+1][j][k]+
                                      ...
                                      As[i][j][k]*P[i][j-1][k]+Au[i][j][k]*P[i][j][k+1]+
                                      Ad[i][j][k]*P[i][j][k-1]))+(1-w)*P[i][j][k];
